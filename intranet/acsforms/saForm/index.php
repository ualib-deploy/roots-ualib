         ...
         <hr>
            ...
            -->
				...
				<div id="loginformprocparams"> 
					...
					<input type="hidden" name="OBWeb_FinalTargetPage" value="https://wwwdev2.lib.ua.edu/intranet/security-authorization-form-landing"/>
					<input type="hidden" name="OBDocumentType" value="755" /><!-- OBTEST: 755 OBPROD: 884 -->
					<input type="hidden" name="OBWeb_Redirect" value="https://wwwdev2.lib.ua.edu/intranet/security-authorization-form-landing"/>
				</div>

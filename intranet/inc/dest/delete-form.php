  ...
  <div class="container">
		<form action="https://imageweb-test.ua-net.ua.edu/Public/LoginFormProc.aspx?FromLoginFormProc=true" method="post">
			...
			<div id="loginformprocparams"> 
				...
				<input type="hidden" name="OBWeb_FinalTargetPage" value="https://www.lib.ua.edu/intranet/delete-form-landing"/>
				<input type="hidden" name="OBDocumentType" value="775" />
				<input type="hidden" name="OBWeb_Redirect" value="https://www.lib.ua.edu/intranet/delete-form-landing"/>
			</div>

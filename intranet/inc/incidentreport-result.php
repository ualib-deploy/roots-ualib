...
// Compile Body ($htmlemailbody)
	...
	/* if ($_POST[descriptionna] == "checked") {
		...
		<tr><td>Height: ' . $_POST['descirptionheight'] . '</td><td>
...
// Setup email ($incidentemail)
	...
	/* $incidentemail->AddCC("tcwilson@ua.edu", "Tom Wilson"); */
        ...
        /* $incidentemail->AddCC("kchapman@bruno.cba.ua.edu", "Karen Chapman"); */
	...
	case "Gorgas":
		// $incidentemail->AddCC("mljackson@ua.edu", "Millie Jackson");
		// $incidentemail->AddCC("tcwilson@ua.edu", "Tom Wilson");
                // $incidentemail->AddCC("jjbattles@ua.edu", "Jason Battles");
		/* $incidentemail->AddCC("cdavis@ua.edu", "Cornelia Davis"); */
                // $incidentemail->AddCC("jlrichardson5@ua.edu", "Jennifer Richardson");
                //$incidentemail->AddCC("pearc007@ua.edu", "Michael Pearce");
                break;
	case "Bruno":
		// $incidentemail->AddCC("lpike@bruno.cba.ua.edu", "Lee Pike");
		/* $incidentemail->AddCC("kchapman@bruno.cba.ua.edu", "Karen Chapman"); */
		break;
	case "Hoole":
		...
		break;
	case "McLure":
		// $incidentemail->AddCC("hvissche@ua.edu", "Helga Visscher");
	...
	case "Rodgers":
        ...
        case "Annex":
                ...
                //$incidentemail->AddCC("mbpaluzzi@ua.edu", "Mary Bess Paluzzi");
...
?><?php
	...
	<p align="center">
	<a href="http://intranet.lib.ua.edu">Return to Intranet Home</a>
	</p>';

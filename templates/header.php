                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group-checkbox" id="scoutCheckbox"><span>Just search Scout</span>&nbsp;<input type="checkbox" ng-model="scoutCheckbox" ng-change="checkboxChange()"></input></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

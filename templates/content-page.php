...
'voyager-request-result') ))
      ...
      if(is_page('circ-trace-form-result'))
        require_once get_stylesheet_directory() . '/intranet/inc/circ-trace-form-result.php';

      if(is_page('studentemployeerequest-result'))
        require_once get_stylesheet_directory() . '/intranet/inc/studentemployeerequest-result.php';

      if(is_page('actcardform-result'))
        require_once get_stylesheet_directory() . '/intranet/inc/actcardform-result.php';
